...
{
	/// <summary>
	/// Translated and converted from org.apache.tika.parser.microsoft.ooxml and
	/// org.apache.poi.hwpf.converter with some enhancements for bullets and indentation.
	///
	/// Pulled from dnGrep, thanks!
	/// </summary>
	/// <remarks>
	...
	public class WordListManager : ListManager
	{
		...
		internal static string TwipsToSpaces(string value)
		{
			if (!string.IsNullOrWhiteSpace(value))
			{
				...
				{
					// 1440 twips = 1 inch make 1 inch == 6 spaces
					int spaces = num / 240;
