	...
	public class ColorButton : System.Windows.Forms.Button
	{
		...
		private class ColorPaletteDialog : BaseForm
		{
			...
			public ColorPaletteDialog(Point startingPoint, Color selectedColor)
			{
				...
				this.BackColor = Core.Theme.ThemeProvider.Theme.Colors.Control;
				// form properties
				...
				__otherButton.ForeColor = Core.Theme.ThemeProvider.Theme.Colors.ForeColor;
		...
		/// <summary>
		/// The current back color (provided by theming).
		/// </summary>
		public override Color BackColor { get => Core.Theme.ThemeProvider.Theme.Colors.Control; }
		...
		public Color SelectedColor
		{
			...
			set
			{
				// fixes some weirdness when using designer selected colors
		...
		private void ButtonPaint(object sender, PaintEventArgs e)
		{
			...
			Pen pen = new Pen(Core.Theme.ThemeProvider.Theme.Colors.ForeColor);
