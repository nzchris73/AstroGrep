	  ...
	  public FilterType(Categories category, SubCategories subCategory)
	  {
		 ...
		 switch (subcat)
		 {
			...
			case SubCategories.Path:
			   ...
			   supportedValueOptions = new List<ValueOptions>() { ValueOptions.Equals, ValueOptions.NotEquals, ValueOptions.Contains, ValueOptions.NotContains, ValueOptions.StartsWith, ValueOptions.EndsWith };
